...
type RouteMod = typeof import('@/app/api/monthly-recap-legacy/process-step1/route')
...
describe.skipIf(!ENABLED)('POST /api/monthly-recap/process-step1 — characterization', () => {
  ...
  beforeAll(async () => {
    ...
    const routeMod = await import('@/app/api/monthly-recap-legacy/process-step1/route')
    POST = routeMod.POST

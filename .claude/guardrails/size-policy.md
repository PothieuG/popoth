...
│   └─ roadmap-detailed-15-skeleton-refetch-loaders.md         14k   Skeleton-Refetch-Loaders (1) — créée 2026-05-21 (Part 14 a atteint le cap 38k post-extension)
│
├─ reference/
...
│   ├─ operational-rules.md                           40k   Path B closed-by-deletion + god-files + cleanup-attempts CRITIQUES + ❌ rules (Modals & UI extraite) — over 38k cap post §6 chronologie extension Sprints Delete-Budget+Fix-Savings+Fix-Dashboards-Navbar-Switch 2026-05-20, candidat §6 extraction
│   └─ operational-rules-ui-modals.md                 24k   22 → 25 règles ❌ Modals & UI (extraite Sprint Drawer-Slide-Fix 2026-05-20 + étendue Modal-Uniformize/Polish/Dropdown-Portal 2026-05-21 + 5 règles nav SPA / loader inline / layout partagé Sprint Fix-Dashboards-Navbar-Switch 2026-05-20 + 3 règles isFetching/InlineSpinner/CentralLoader Sprint Skeleton-Refetch-Loaders 2026-05-21)
│
└─ guardrails/
    └─ size-policy.md                                 13k   (ce fichier)
```

**Total contexte** : ~760k chars répartis sur 28 fichiers. CLAUDE.md (~39k) reste légèrement au-delà du plafond 38k mais sous 40k (limite Claude Code). operational-rules.md à **~40k** (Modals & UI section délocalisée vers `operational-rules-ui-modals.md` 24k mais §6 chronologie sprints ré-étendue post-extraction → candidat extraction §6 vers `.claude/history/sprint-chronology.md` au prochain sprint touchant ces invariants). Roadmap-14 à 36k post-extension Fix-Dashboards-Navbar-Switch 2026-05-20 (sous le cap 38k, marge confortable). Roadmap-15 à 14k (fresh, ouverte 2026-05-21 pour Skeleton-Refetch-Loaders). Roadmap-12 (~39k) toujours à splitter au prochain sprint touchant Refactor-Recover.
...
| `conventions/operational-rules-ui-modals.md`                     | ~15k          | 38k     |
...
- 15× `.claude/history/roadmap-detailed-01..15-*.md` (8-39k — Part 12 a franchi 38k post-Fix-Password-Reset-OTP, Part 13 à ~37k post-Drawer-Slide-Fix-And-Header-Harmonize, Part 14 à 36k post-extension Fix-Dashboards-Navbar-Switch 2026-05-20, Part 15 à 14k post-création 2026-05-21 — sous le cap 38k)
...
- 6× `.claude/conventions/{zod-patterns,typescript,logs-cleanup,git-workflow,operational-rules,operational-rules-ui-modals}.md` (4-40k — operational-rules à ~40k post-extension §6 chronologie 2026-05-20, candidat extraction §6 prochain sprint ; operational-rules-ui-modals à 20k via Sprints Modal-Uniformize/Polish/Dropdown-Portal 2026-05-21 + 5 règles nav Sprint Fix-Dashboards-Navbar-Switch 2026-05-20)

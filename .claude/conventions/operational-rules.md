...
> Extraite 2026-05-20 (Sprint Drawer-Slide-Fix-And-Header-Harmonize) vers [operational-rules-ui-modals.md](operational-rules-ui-modals.md) pour respecter la [size-policy](../guardrails/size-policy.md) 38k. 11 règles ❌ couvrant Dialog/ModalCloseX, drawer swap horizontal, loading patterns, sections plates iOS, footer pinned destructive, false-affordance, lazy-mount, et le Tailwind v4 alphabetical-sort gotcha sur `tw-animate-css`.
...
Pour la chronologie complète des 99 sprints, voir CLAUDE.md §11 (index des 13 parts `.claude/history/roadmap-detailed-NN-...md`).

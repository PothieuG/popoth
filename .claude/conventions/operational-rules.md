...
- ❌ **NE PAS** calculer `budgetRemaining = estimated − spent` sans `carryover_spent_amount` — [Part 34](../history/roadmap-detailed-34-allow-negative-rav-and-deficit-bug.md) sprint Fix-Preview-Allocation-Carryover.

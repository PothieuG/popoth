...
lib/
  ...
  recap/                   # ✅ Sprint State-Lock-Schemas-V3 (sub-task 03/17 Monthly Recap V3, 2026-05-24) + Calculations-V3 (sub-task 04/17, 2026-05-23) — fondations pure-async + calculs purs, 0 endpoint
    ...
    index.ts               # barrel — consumers : import { checkRecapStatus, isRecapBlocking, RECAP_STEP_ORDER, computeRecapSummary, computeProportionalSavingsRefloat, computeProportionalBudgetSnapshot, type RecapStep, type RecapSummary, ... } from '@/lib/recap'

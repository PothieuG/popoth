  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] bg-background fixed inset-4 top-[50%] z-50 grid w-auto max-w-none translate-y-[-50%] gap-3 rounded-lg border p-4 shadow-lg duration-200 sm:inset-auto sm:left-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:rounded-lg sm:p-6',
          className,
        )}
        {...props}
      >

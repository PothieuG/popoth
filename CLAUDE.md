...
| Tests non-gated passants               | **800**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score ~100. Lint 0/0. Tests 800/228. 44 routes. 25 RPCs + 36 fn. **MRv3** 01-17 + **PÉ** 01-12 livrés. Deadlock wizard step 4 sans ressources fermé. ⚠️ Dette `carryover ≥ estimated` (5 pistes, cf. [Part 34](.claude/history/roadmap-detailed-34-allow-negative-rav-and-deficit-bug.md)).

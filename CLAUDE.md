...
| Tests non-gated passants                  | **501**                   | `pnpm test:run`                                                                                                          |
...
**Historique détaillé verbatim des 105 sprints livrés** — 14 parts chronologiques sous `.claude/history/roadmap-detailed-NN-...md` :

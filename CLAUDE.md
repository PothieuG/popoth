...
| Tests non-gated passants                  | **515**                   | `pnpm test:run`                                                                                                          |
...
- **Total** : ~515 non-gated + 98 gated skipped (sans env vars).
...
**État global** : Score audit estimé ~100/100. Lint baseline 0/0. Tests 515 non-gated / 98 gated. 54 routes API. 11 RPCs pinnées (cf. §5.5).

**Historique détaillé verbatim des 108 sprints livrés** — 16 parts chronologiques sous `.claude/history/roadmap-detailed-NN-...md` :

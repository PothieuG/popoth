...
| Tests non-gated passants               | **695**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score ~100/100. Lint 0/0. Tests 695/211. 43 routes API. 25 RPCs + 34 fn (§5.5). **Monthly Recap V3** sprints 01-17 livrés (cf. §5 + Part 24).

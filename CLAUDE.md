...
| Tests non-gated passants                  | **513**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score audit estimé ~100/100. Lint baseline 0/0. Tests 513 non-gated / 98 gated. 54 routes API. 11 RPCs pinnées (cf. §5.5).

**Historique détaillé verbatim des 109 sprints livrés** — 16 parts chronologiques sous `.claude/history/roadmap-detailed-NN-...md` :

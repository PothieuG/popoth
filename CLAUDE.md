...
| Tests non-gated passants               | **812**                   | `pnpm test:run`                                                                                                          |
| Tests gated skipped                    | **234**                   | idem (`SUPABASE_*_TESTS=1` activent)                                                                                     |
| Routes API                             | **45**                    | `pnpm build`                                                                                                             |
| Functions DB versionnées               | **43/43**                 | `pnpm db:audit-functions`                                                                                                |
...
**État global** : Score ~100. Lint 0/0. Tests 812/234. 45 routes. 28 RPCs + 43 fn. MRv3+PÉ livrés. Sprint Group-Income-Cascade : revenus estimés groupe → recalcul contributions (clamp 0).

**Historique** — 37 parts (149 sprints) :

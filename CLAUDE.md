...
| `pnpm db:check-rpcs`                       | Vérifie présence des **21 RPCs pinnées** dans `pg_proc`                                                                                   |
...
| -------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| `EXPECTED_RPCS`                        | **21**                    | [scripts/check-rpcs.mjs](scripts/check-rpcs.mjs)                                                                         |
...
| Functions DB versionnées               | **30/30**                 | `pnpm db:audit-functions`                                                                                                |
...
**État global** : Score ~100/100. Lint 0/0. Tests 672/203. 41 routes API. 21 RPCs + 30 fn (§5.5). **Monthly Recap V3** sprints 01-17 livrés (cf. §5 + Part 24). Récents : Consume-Surplus (27), Auto-Cascade-Piggy (28).

**Historique** — 28 parts `.claude/history/roadmap-detailed-NN-*.md` (130 sprints) :

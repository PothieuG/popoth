...
- ⏭️ **GH Actions Node.js 24 migration** (Sprint Polish-CI / D6 défer) : `actions/checkout@v4`, `setup-node@v4`, `pnpm/action-setup@v4` warnent "Node.js 20 deprecated, forced to 24 starting June 2nd, 2026". Stratégie : laisser auto-upgrade arriver, observer, ajuster si breakage. Ré-évaluer en avril 2026.

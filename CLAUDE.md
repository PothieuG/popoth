...
| Tests non-gated passants               | **611**                   | `pnpm test:run`                                                                                                          |
| Tests gated skipped (sans env vars)    | **177**                   | idem (`SUPABASE_*_TESTS=1` activent)                                                                                     |
| Routes API                             | **40**                    | `pnpm build`                                                                                                             |
| Functions DB versionnées               | **26/26**                 | `pnpm db:audit-functions`                                                                                                |
...
**État global** : Score audit estimé ~100/100. Lint baseline 0/0. Tests 611 non-gated / 177 gated. 40 routes API. 19 RPCs pinnées + 26 functions versionnées (cf. §5.5). **Monthly Recap V3** — sprints 01-15/17 livrés (cf. §5 + Part 23).

**Historique** — 23 parts `.claude/history/roadmap-detailed-NN-*.md` (127 sprints) :

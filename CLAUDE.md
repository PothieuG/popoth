...
| Tests non-gated passants               | **797**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score ~100. Lint 0/0. Tests 797/228. 45 routes. 28 RPCs + 38 fn. **MRv3** 01-17 + **PÉ** 01-12 livrés. ⚠️ Reste ouvert : finalité UX cap auto/refloat sur dette `carryover_spent_amount ≥ estimated` (cf. [Part 34](.claude/history/roadmap-detailed-34-allow-negative-rav-and-deficit-bug.md)).

**Historique** — 36 parts (148 sprints) :

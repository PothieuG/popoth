...
| Tests non-gated passants               | **823**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score ~100. Lint 0/0. Tests 823/234. 45 routes. 28 RPCs + 43 fn. MRv3+PÉ livrés. Dernier : RAV estimé vert/rouge dans les encarts du planificateur (solo + groupe).

**Historique** — 38 parts (150 sprints) :

...
| Tests non-gated passants               | **793**                   | `pnpm test:run`                                                                                                          |
...
**État global** : Score ~100. Lint 0/0. Tests 793/227. 44 routes. 25 RPCs + 36 fn. **MRv3** 01-17 + **PÉ** 01-12 livrés. ⚠️ **État ouvert** : dette `carryover_spent_amount ≥ estimated` peut piéger un budget — 4 sprints de fix livrés (dont preview/allocation 2026-05-27) mais finalité UX (cap auto, refloat) ouverte, cf. [Part 34](.claude/history/roadmap-detailed-34-allow-negative-rav-and-deficit-bug.md).

**Historique** — 34 parts (145 sprints) :

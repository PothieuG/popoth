...
| Tests non-gated passants               | **672**                   | `pnpm test:run`                                                                                                          |
| Tests gated skipped                    | **207**                   | idem (`SUPABASE_*_TESTS=1` activent)                                                                                     |
...
**État global** : Score ~100/100. Lint 0/0. Tests 672/207. 43 routes API. 25 RPCs + 34 fn (§5.5). **Monthly Recap V3** sprints 01-17 livrés (cf. §5 + Part 24).

**Historique** — 29 parts (132 sprints) :

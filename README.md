...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après **Sprint 2-followup-v3 (FK ON DELETE SET NULL pinned + AuthContext useReducer migration)** 2026-05-10 (**~97.5/100**) :
...
- [`prompt/`](./prompt/) — prompts Claude Code par sprint, du Sprint 0 (v0) à Sprint 2-followup-v3 (livré 2026-05-10, prompt v6) + le prompt suivant [`prompt-04-tooling-dx-v7.md`](./prompt/prompt-04-tooling-dx-v7.md) (pure-unit tests pour `authReducer` + memoize `userValue`/`actionsValue`). Voir [`prompt/README.md`](./prompt/README.md) pour le sommaire chronologique. Roadmap planifiée dans [CLAUDE.md](./CLAUDE.md) §11 : Sprint 2-followup-v4 (v7 prompt), Sprint Tailwind-v4, Sprint Supabase-Strict-Types, chantier I4 (financial-calculations), chantier I5 (process-step1), chantier console.log cleanup, chantier Zod rollout, GH Actions Node.js 24 migration (juin 2026).

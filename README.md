...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après **Sprint 1 (Industrialisation tooling)** 2026-05-09 (**~94/100**) :
...
- [`prompts/`](./prompts/) — prompts Claude Code par sprint, du Sprint 0 (v0) à Sprint 1 (livré 2026-05-09). Voir [`prompts/README.md`](./prompts/README.md) pour le sommaire chronologique. Voir roadmap §11 dans [CLAUDE.md](./CLAUDE.md) pour les chantiers planifiés : Sprint 1.5 (React Hooks v7 anti-patterns refactor — voir [`prompt/prompt-04-tooling-dx-v2.md`](./prompt/prompt-04-tooling-dx-v2.md)), Sprint Tailwind-v4, Sprint Supabase-Strict-Types, chantier I4 (financial-calculations), chantier I5 (process-step1), chantier console.log cleanup, chantier Zod rollout, GH Actions Node.js 24 migration (juin 2026).

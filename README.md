...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après **Sprint 2-followup-v2 (useGroups invalidation cascade + AuthContext disable narrowing)** 2026-05-10 (**~97/100**) :
...
- [`prompt/`](./prompt/) — prompts Claude Code par sprint, du Sprint 0 (v0) à Sprint 2-followup-v2 (livré 2026-05-10, prompt v5) + le prompt suivant [`prompt-04-tooling-dx-v6.md`](./prompt/prompt-04-tooling-dx-v6.md) (server-side DELETE-group `profile.group_id` cleanup + AuthContext `useReducer` migration optionnelle). Voir [`prompt/README.md`](./prompt/README.md) pour le sommaire chronologique. Roadmap planifiée dans [CLAUDE.md](./CLAUDE.md) §11 : Sprint 2-followup-v3 (v6 prompt), Sprint Tailwind-v4, Sprint Supabase-Strict-Types, chantier I4 (financial-calculations), chantier I5 (process-step1), chantier console.log cleanup, chantier Zod rollout, GH Actions Node.js 24 migration (juin 2026).

...
hooks/                     # 20 hooks React — ✅ Sprint 1.5 : 11 hooks fetcher migrés sur TanStack Query
  ...
  useFinancialData.ts      # ✅ Sprint 1.5 — useQuery + bridge `triggerFinancialRefresh` exports préservés pour back-compat (cleanup en Sprint 2)
...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après **Sprint 1.5 (React Hooks v7 refactor + TanStack Query)** 2026-05-09 (**~95/100**) :
...
- [`prompt/`](./prompt/) — prompts Claude Code par sprint, du Sprint 0 (v0) à Sprint 1.5 (livré 2026-05-09). Voir [`prompt/README.md`](./prompt/README.md) pour le sommaire chronologique. Roadmap planifiée dans [CLAUDE.md](./CLAUDE.md) §11 : Sprint 2 (bridge cleanup post-Sprint 1.5 + commitlint — voir [`prompt/prompt-04-tooling-dx-v3.md`](./prompt/prompt-04-tooling-dx-v3.md)), Sprint Tailwind-v4, Sprint Supabase-Strict-Types, chantier I4 (financial-calculations), chantier I5 (process-step1), chantier console.log cleanup, chantier Zod rollout, GH Actions Node.js 24 migration (juin 2026).

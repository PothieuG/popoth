...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après Sprint Lint-Baseline-Cleanup 2026-05-08 (~83/100) :
...
- [`prompts/`](./prompts/) — prompts Claude Code par sprint, du Sprint 0 (v0) à Sprint Lint-Followups (v3, le plus récent). Voir [`prompts/README.md`](./prompts/README.md) pour le sommaire chronologique. Le prochain prompt à exécuter est [`prompts/prompt-01-inventory-v3.md`](./prompts/prompt-01-inventory-v3.md) (Sprint Lint-Followups : fix bug recover.ts v1/v2, triage des 31 alertes GitHub Advanced Security, hook Husky pre-push). Voir aussi roadmap §11 dans [CLAUDE.md](./CLAUDE.md) pour les chantiers planifiés au-delà : Sprint 1 (Prettier/Husky lint-staged + ESLint 8→9 + eslint-config-next 15→16), Sprint Tailwind-v4, Sprint Supabase-Strict-Types, chantier I4 (financial-calculations), chantier I5 (process-step1), chantier console.log cleanup, chantier Zod rollout, GH Actions Node.js 24 migration (juin 2026).

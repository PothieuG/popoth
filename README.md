...
L'audit complet est dans [`docs/audit/00-executive-summary.md`](./docs/audit/00-executive-summary.md). État après **Sprint 2-followup (helper dedup + tests cascade + debug strip)** 2026-05-09 (**~96.5/100**) :
